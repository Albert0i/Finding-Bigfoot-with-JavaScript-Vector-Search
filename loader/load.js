      ...
      optionList: [
        {
          ...
          description: 'The URL of the API endpoint to post sightings to. Optional. Defaults to http://localhost:3000/api/load.'
        },
        {
          name: 'startingId',
...
async function run() {
  ...
  let endpoint = options.endpoint ?? 'http://localhost:3000/api/load'
...
/*
   ...
   To load data with: 
   npm start -- ../data/bfro_reports_geocoded.jsonl
